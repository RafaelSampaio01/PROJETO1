...
ATUADORES = [
    {"label": "SENSORES EST",        "action": None},
    {"label": "SENSORES KAZI",   "action": None},
    {"label": "SENSORES DR.LUCK",         "action": None},
    {"label": "SENSORES INTERNOS","action": None},
]
